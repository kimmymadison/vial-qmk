...
const uint8_t print_index[][3] = {
    {0,0,8}, {0,0,7}, {0,0,6}, {0,0,5}, {0,0,4}, {0,0,3},
    {1,0,9}, {1,0,0}, {1,0,1}, {1,0,2}, {1,1,4}, {1,1,2},
    {2,1,8}, {2,1,7}, {2,1,6}, {2,1,5}, {2,1,3}, {2,1,1},
    {3,1,9}, {3,1,0}, {3,2,7}, {3,2,6}, {3,2,5}, {3,2,4},
    {4,2,8}, {4,2,9}, {4,2,0}, {4,2,1}, {4,2,2}, {4,2,3}
};
...
uint8_t matrix_scan(void) {
    ...
    if (TIMER_DIFF_32(timer_now, matrix_timer) >= 500) {
        ...
        print_key_matrix(print_index, ARRAY_LEN(print_index));
